...
export default function AdminSidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-64 min-h-screen bg-gradient-to-b from-gray-900 to-gray-950">
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-800">
        <img src="/icons/banners/logo.png" className="h-10 w-auto" alt="Logo" />
      </div>
                ...
                return (
                  <li key={item.id}>
                    {item.href ? (
                      ...
                      <div className="px-3 py-2.5 text-sm text-gray-500">{item.label}</div>
                    )}
                  </li>
                );
              })}
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-800/50">
          ...
          <div>
            <p className="text-xs font-medium text-gray-300">Hệ thống</p>
