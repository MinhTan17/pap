    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Thông tin liên hệ */}
          <div>
            <h3 className="text-xl font-bold mb-4">PHÚ AN PHÁT</h3>
            {/* <p className="text-base text-gray-400 mb-3">NHÀ CUNG CẤP THÉP CHUYÊN NGHIỆP</p> */}
            <div className="space-y-2 text-gray-300">
              <p>
                <span className="font-semibold">{t('address')}:</span><br />
                Đường số 9, KCN Tam Phước, p. Tam Phước, Đồng Nai
              </p>
              <p>
                <span className="font-semibold">{t('hotline')}:</span> 0931 535 007
              </p>
              <p>
                <span className="font-semibold">{t('email')}:</span> sales.phuanphat@gmail.com
              </p>
              <p>
                <span className="font-semibold">{t('website')}:</span> www.phuanphat.com.vn
              </p>
            </div>
