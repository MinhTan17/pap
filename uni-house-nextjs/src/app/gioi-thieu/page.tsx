  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden relative">
                ...
                {/* Navigation Arrows */}
                <button 
                  onClick={() => setCurrentImage(currentImage === 0 ? officeImages.length - 1 : currentImage - 1)}
                ...
                <button 
                  onClick={() => setCurrentImage((currentImage + 1) % officeImages.length)}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">NHÂN LỰC</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">THIẾT BỊ</h2>
            <div className="w-24 h-1 bg-gray-300 mx-auto"></div>
          </div>
